...
const nextConfig = (phase) => {
  ...
  const cspHeader = `
    default-src 'self';
    script-src 'self' 'unsafe-inline' ${isDev ? "'unsafe-eval' " : ""}https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://us-assets.i.posthog.com https://us.i.posthog.com;
