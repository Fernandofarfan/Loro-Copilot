...
export function OpenAIMark({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export function AnthropicMark({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M14.5 3L21 21h-3.8l-1.4-4.1H8.2L6.8 21H3L9.5 3h5zm-1.1 4.1L10 13.9h4l-3.4-6.8z" />
    </svg>
  );
}
...
export function GoogleMark({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm4.8 11.2h-4.8v-2.4h7.1a5.6 5.6 0 0 1-.2 1.8 5.9 5.9 0 0 1-2.1 3.2 6.1 6.1 0 0 1-4.8 1.4 6 6 0 0 1-5.7-4.4 6.1 6.1 0 0 1 1.4-6.1 6.1 6.1 0 0 1 6.2-1.2 5.8 5.8 0 0 1 3.4 2.8l-1.9 1.9a3.2 3.2 0 0 0-2.3-1.6 3.4 3.4 0 0 0-3.3 2.4 3.5 3.5 0 0 0 1 3.7 3.4 3.4 0 0 0 3.8.7 3 3 0 0 0 1.7-1.8z" />
    </svg>
  );
}

export function DeepSeekMark({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 3a9 9 0 0 0-9 9c0 3.7 2.3 6.9 5.6 8.2l.9-1.8A7.2 7.2 0 0 1 5 12a7 7 0 1 1 14 0c0 2.8-1.6 5.3-4 6.4l.9 1.8A9 9 0 0 0 12 3zm0 4a5 5 0 1 0 0 10 5 5 0 0 0 0-10z" />
    </svg>
  );
}
...
export function ThumbUpIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M7 10v12" />
...
export function ThumbDownIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M17 14V2" />
...
export function VolumeIcon({ size = 15 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
