...
export const COMPANY_DOSSIERS: Record<string, CompanyDossier> = {
  mercadolibre: {
    ...
    techStack: ["Go (Golang)", "Java", "Python", "Kubernetes", "AWS DocumentDB", "GCP (Firestore / Cloud Storage)", "Istio (Service Mesh)", "Redis", "Kafka", "MySQL/Percona"],
    notableTools: ["Fury (PaaS interno y protocolo de serialización)", "BigQueue", "Melictl", "Eightfold AI (Valeria)", "Istio Service Mesh", "Database Proxy / Query Gateway"],
    architectureStyle: "Microservicios de alta concurrencia, DBaaS multi-nube (AWS DocumentDB a GCP Firestore), segmentación/sharding, resiliencia y baja latencia P99",
    ...
    interviewTips: [
      ...
      "Para la IA Valeria (Eightfold): estructura STAR estricta, alta densidad de keywords de la JD (DocumentDB, Firestore, sharding, Istio, latency P99)",
      "Enfatizar experiencia multi-cloud: ~4 años sólidos en GCP + Kubernetes como puente natural para convivir con AWS",
      "Uso diario de IA: citar asistentes de código, benchmarking automatizado de queries y testing guiado por LLMs",
      "Demostrar experiencia en APIs idempotentes, database proxies y transacciones distribuidas",
  ...
  globant: {
    ...
    aliases: ["globant", "intermedia", "globant / intermedia", "the agency"],
    techStack: [
    ...
    architectureStyle: "Arquitecturas cloud empresariales, modernización hacia GCP, migración híbrida con GCVE y automatización IaC con Terraform",
    ...
    interviewTips: [
      ...
      "Enfatizar automatización con Terraform y migración híbrida segura entre VMware y GCP nativo",
      "Mantener la distinción de +8 años totales en IT y ~4 años dedicados a GCP y cloud",
      "Para small talk y switch a inglés: ser cálido y conciso citando a tu perrita Luna en Salta",
    ],
  },
  nubank: {
